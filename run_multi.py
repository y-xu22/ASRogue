...
## python run_multi.py {step2, allp2c, allrel} {ASsize, allrand, p2p} {round}

if len(sys.argv) < 4:
    print("python run_multi.py {step2, allp2c, allrel} {ASsize, allrand, p2p} {round}")
    exit()
